...
const PLUG_POSITION_STORAGE_KEY = "ctrl.dashboard.plugPosition.v3";
const DEFAULT_PLUG_POSITION = { left: 1088, bottom: 138 };
const ENABLE_PLUG_CALIBRATION = false;

const TOP_BURNS_STORAGE_KEY = "ctrl.dashboard.topBurns.v3";
const TOP_BURNS_LIMIT = 5;
const TOP_BURNS_POSITION_STORAGE_KEY = "ctrl.dashboard.topBurnsPosition.v3";
const DEFAULT_TOP_BURNS_POSITION = { left: 270, top: 206 };
